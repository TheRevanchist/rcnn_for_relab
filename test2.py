...
def test_net(name, net, imdb, max_per_image=300, thresh=0.3, vis=False):
    ...
    for i in range(3, num_images):
        ...
        for j in xrange(1, imdb.num_classes):
            ...
            if cls_dets.shape[0] != 0:
                all_class_boxes.append(cls_dets)
            print(len(all_class_boxes))
        ...
        #print(len(all_scores), len(all_class_boxes))

        # check if we have two bounding boxes with the same coordinates
        # all_class_boxes = np.asarray(all_class_boxes)
        # for ii in range(len(all_class_boxes)):  # generate pairs
        #     for jj in range(ii + 1, len(all_class_boxes)):
        #         if np.array_equal(all_class_boxes[ii], all_class_boxes[jj]):  # compare rows
        #             print (i)
...
if __name__ == '__main__':
    ...
    # evaluation
    all_boxes = test_net(save_name, net, imdb, max_per_image, thresh=thresh, vis=1)
    print("meh")
